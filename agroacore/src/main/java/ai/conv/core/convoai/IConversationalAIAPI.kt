...
/**
 * Location message for sending location data to AI agents.
 *
 * Used to report device location information including longitude and latitude.
 *
 * Usage examples:
 * - Basic location: LocationMessage(longitude = "12.21", latitude = "12.32")
 *
 * @property clientId Device ID
 * @property recordId Record ID (temporarily empty)
...
//AI识图专用Message
data class AiImageMessage(
    val clientId: String = "",
    val recordId: String = "",
    val type    :String ="GLASS_VLM_IMAGE_URL_UP",
